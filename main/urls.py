...
from main.views import show_main, register, login_user, logout_user, show_product, get_product_json, add_product_ajax, edit_product_ajax, delete_product_ajax, get_product_by_id_ajax, register_ajax, login_ajax
